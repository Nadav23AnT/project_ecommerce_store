...
import { CustomerModelType } from '../types/customerModelType';

const customerSchema: Schema = new Schema<CustomerModelType>(
  {
    customerTypeId: {
...
const Customer = model<CustomerModelType>('Customer', customerSchema);
